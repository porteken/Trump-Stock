...
rm(list=ls())
gc()
pacman::p_load(tidyverse,reticulate,quantmod,rtweet,data.table,lubridate,e1071,doParallel,DT,feasts,caret,future,fable,data.table,tsibble,install = T,update=T)
library(tidyverse)
library(reticulate)
library(quantmod)
library(rtweet)
